...
app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv("DATABASE_URL",'postgresql://postgres:DB_PASSWORD_REMOVED@localhost/adaptive_learning_db')
...
def run_code_executor(language, code):
    try:
        ...
        response = requests.post(
            ...
            json={
                "clientId": "JDOODLE_CLIENT_ID_REMOVED",
                "clientSecret": "JDOODLE_CLIENT_SECRET_REMOVED",
                "script": code,
